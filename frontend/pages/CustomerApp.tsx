    ...
    const handleOrderStatusChanged = (data: any) => {
      ...
      if (data?.status) {
        ...
        const statusMap: Record<string, string> = {
          ...
          ON_THE_WAY: isMart ? 'Driver sedang menuju merchant' : 'Driver sedang menuju titik penjemputan',
          ARRIVED: isMart ? 'Driver telah tiba di lokasi merchant' : 'Driver telah tiba di titik penjemputan',
          PICKED_UP: isMart ? 'Pesanan diambil, driver menuju customer' : 'Perjalanan menuju lokasi tujuan',
          ARRIVED_CUSTOMER: isMart ? 'Driver telah tiba di lokasi customer' : 'Driver telah tiba di lokasi tujuan',
